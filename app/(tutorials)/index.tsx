...
const TUTORIALS: Tutorial[] = [
  {
    ...
    description:
      "Learn the basics of React Native components and how to style them",
  ...
  },
  {
    ...
    title: "Hooks & Effects",
    description:
      "Learn useEffect and other hooks for side effects and lifecycle",
  ...
  },
  {
    ...
    description:
      "Render efficient lists with FlatList and optimize performance",
        ...
        <ThemedView style={styles.cardsContainer}>
          {TUTORIALS.map((tutorial, index) => (
            ...
            >
              ...
              <View
                style={[styles.cardHeader, { backgroundColor: tutorial.color }]}
              >
