...
Also provides type checking in TypeScript`}
          ...
          <View style={styles.styledBox}>
            <Text style={[styles.styledText, isDark && styles.styledTextDark]}>
        ...
        <ThemedView style={styles.lessonBox}>
          ...
          <ThemedText>
            Pressable makes elements interactive.
            It provides pressed state styling.
          </ThemedText>
        ...
        <ThemedText style={styles.footer}>
          💡 Key Takeaway: React Native styling is similar to CSS but uses JS objects and camelCase property names
        </ThemedText>
      </ThemedView>
    </ScrollView>
  );
