...
- Support for deep linking`}
          ...
          <ThemedView style={styles.lessonBox}>
            ...
            <View style={styles.structureBox}>
              ...
              <Text style={styles.structureSubtext}>
                {" "}
  ...
  └─ explore.tsx (Second tab)`}
            ...
            <View style={styles.pattern}>
              <Text style={styles.patternTitle}>
                _layout.tsx creates navigation:
              </Text>
              <Text style={styles.patternCode}>
    ...
    <Tabs>
      ...
      <Tabs.Screen name="explore" options={{...}} />
          ...
          <ThemedView style={styles.lessonBox}>
            ...
            <ThemedText>
              Deep linking lets you navigate from external sources (emails,
              notifications)
            </ThemedText>
...
myapp://post/456?view=full`}
          ...
          <ThemedText style={styles.footer}>
            💡 Key Takeaway: Expo Router makes navigation type-safe and
            organized!
          </ThemedText>
        </ThemedView>
      </ScrollView>
