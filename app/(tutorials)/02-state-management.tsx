...
Syntax: const [value, setValue] = useState(initialValue)`}
          ...
          <ThemedView style={styles.lessonBox}>
            ...
            <ThemedText>Showing toggle state</ThemedText>
          ...
          <ThemedView style={styles.lessonBox}>
            ...
            <ThemedText style={styles.note}>
              📝 Note: When updating objects, use the spread operator (...) to
              create a new object
            </ThemedText>
          </ThemedView>
          ...
          <ThemedView style={styles.lessonBox}>
            ...
            <ThemedText>Managing lists of items with state</ThemedText>
            ...
            <ThemedText style={styles.note}>
              📝 Note: When adding to an array, create a new array with [...old,
              new]
            </ThemedText>
          </ThemedView>
          ...
          <ThemedView style={styles.lessonBox}>
            ...
            <View style={styles.pattern}>
              ...
              <Text style={styles.patternCode}>user.age = 30 // ❌ Wrong</Text>
            </View>
          </ThemedView>

          <ThemedText style={styles.footer}>
            💡 Key Takeaway: Always create new objects/arrays when updating
